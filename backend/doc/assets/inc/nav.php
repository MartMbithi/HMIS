        ...
        <ul class="list-unstyled topnav-menu topnav-menu-left m-0">
            ...
            <li class="dropdown d-none d-lg-block">
                ...
                <div class="dropdown-menu">
                    ...
                    <!-- item-->
                    <a href="his_doc_add_payroll.php" class="dropdown-item">
                        <i class="fe-layers mr-1"></i>
                        <span>Payroll</span>
                    </a>

                    <!-- item-->
                    <a href="his_doc_add_vendor.php" class="dropdown-item">
                    ...
                    <!-- item-->
                    <a href="his_doc_add_medical_record.php" class="dropdown-item">
                    ...
                    <!-- item-->
                    <a href="his_doc_surgery_records.php" class="dropdown-item">
